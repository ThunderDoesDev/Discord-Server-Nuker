...
This repository contains a Discord Nuke Bot that automates mass deletion of roles, channels, banning members, and more. It also includes features like a **user whitelist** and a **progress bar** to track the status of operations.
...
You can exempt specific users from being banned or kicked by adding their user IDs to the whitelist array:
...
The bot logs the results of each operation to a log file, which will be created in the root directory, named with the current date and time.
